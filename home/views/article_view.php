...
<div id="main" role="main" class="clearfix">
	<div id="left">
		<article>
			<div class="post">
				<header>
					<h3 class="posttitle"><?=stripcslashes($article['title'])?></h3>
				</header>
				<div class="postauths">
				...
				<script>var contents = $(".posttitle").text();window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"我找到了一篇好的文章，“"+contents+"”，来自：王永东个人博客 ，博客地址:<?=HOST?>。","bdMini":"2","bdMiniList":["mshare","qzone","tsina","weixin","renren","tqq","kaixin001","tieba","sqq","douban","ty","twi","fbook","mail","copy","print"],"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
				<!-- Baidu Button END -->
			</div>
			<div class="clear"></div>
			<div class="nextinfo">
