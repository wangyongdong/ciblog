	    ...
	    <div class="sidebar">
	        ...
	        <ul id="nav">
				<!-- Main menu with font awesome icon -->
	          	...
	          	<li class="has_sub">
	          		<a href="#" class="open"><i class="icon-file-alt"></i> 学无止境 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
		            <ul>
				...
				<li class="has_sub">
	          		<a href="#"><i class="icon-file-alt"></i> 用户管理 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
		            <ul>
